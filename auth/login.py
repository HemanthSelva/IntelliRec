...
(function(){
  ...
  function fixCB(){
    doc.querySelectorAll('label[data-baseweb="checkbox"]').forEach(function(lbl){
      ...
      /* Find the visual box: div that is the direct parent of the SVG */
      var visualBox = null;
      ...
      /* Clear all div backgrounds except the visual box */
  ...
  /* Watch only structural + aria-checked changes (not 'style' — avoids
     infinite loop where our own setProperty re-triggers the observer) */
